...
unsafe_behavior = [
	{'6.01 防护、保险、信号等装置缺乏或有缺陷':[
												...
												{'6.01.2 防护不当':['6.01.2.1 防护罩未在适应位置',
																'6.01.2.2 防护装置调整不当',
	...
	{'6.02 设备、设施、工具、附件有缺陷':[
											{'6.02.1 设计不当，结构不合安全要求':['6.02.1.1 通道门遮挡视线',
																			'6.02.1.2 制动装置有缺欠',
																			'6.02.1.3 安全间距不够',
																			'6.02.1.4 拦车网有缺欠',
																			'6.02.1.5 工件有锋利毛刺、毛边',
											...
											{'6.02.2 强度不够':['6.02.2.1 机械强度不够',
																'6.02.2.2 绝缘强度不够',
																'6.02.2.3 起吊重物的绳索不合安全要求',
																'6.02.2.4 其他']
											},
											{'6.02.3 设备在非正常状态下运行':['6.02.3.1 设备带“病”运转',
																			'6.02.3.2 超负荷运转',
																			'6.02.3.3 其他']
											},
											{'6.02.4 维修、调整不良':['6.02.4.1 设备失修',
																	'6.02.4.2 地面不平',
																	'6.02.4.3 保养不当、设备失灵',
																	'6.02.4.4 其他']
											}
	...
	{'6.03 个人防护用品用具一防护服、手套、护目镜及面罩、呼吸器官护具、听力护具、安全带、安全帽、安全鞋等缺少或有缺陷':['6.03.1 无个人防护用品、用具',
																										'6.03.2 所用防护用品、用具不符合安全要求']},
	{'6.04 生产(施工)场地环境不良':[
									{'6.04.1 照明光线不良':['6.04.1.1 照度不足',
															'6.04.1.2 作业场地烟雾尘弥漫视物不清',
															'6.04.1.3 光线过强']
									},
								{'6.04.2 通风不良':['6.04.2.1 无通风',
													'6.04.2.2 通风系统效率低',
													'6.04.2.3 风流短路',
													'6.04.2.4 停电停风时放炮作业',
								...
								'6.04.3 作业场所狭窄',
								{'6.04.4 作业场地杂乱':['6.04.4.1 工具、制品、材料堆放不安全',
														'6.04.4.2 采伐时，未开“安全道”',
...
#不安全行为
unsafe_condition = [
	{'7.01 操作错误,忽视安全,忽视警告':['7.01.1 未经许可开动、关停、移动机器',
									'7.01.2 开动、关停机器时未给信号',
	...
	{'7.02 造成安全装置失效':['7.02.1 拆除了安全装置',
							'7.02.2 安全装置堵塞、失掉了作用',
							'7.02.3 调整的错误造成安全装置失效',
							'7.02.4 其他']
	},
	{'7.03 使用不安全设备':['7.03.1 临时使用不牢固的设施',
							'7.03.2 使用无安全装置的设备',
							'7.03.3 其他']
	},
	{'7.04 手代替工具操作':['7.04.1 用手代替手动工具',
							'7.04.2 用手清除切屑',
							'7.04.3 不用夹具固定、用手拿工件进行机加工']
	},
	'7.05 物体(指成品半成品、材料、工具切和生产用品等) 存放不当',
	{'7.06 冒险进入危险场所':['7.06.1 冒险进入涵洞',
							'7.06.2 接近漏料处 (无安全设施)',
	...
	'7.10 有分散注意力行为',
	{'7.11 在必须使用个人防护用品用具的作业或场合中,忽视其使用':['7.11.1 未戴护目镜或面罩',
															'7.11.2 未戴防护手套',
															'7.11.3 未穿安全鞋',
															'7.11.4 未戴安全帽',
															'7.11.5 未佩戴呼吸护具',
															...
															'7.11.7 未戴工作帽',
															'7.11.8 其他']},
	{'7.12 不安全装束':['7.12.1 在有旋转零部件的设备旁作业穿过肥大服装',
...
#直接原因：不安全物态和不安全行为
direct_causes = [unsafe_behavior,unsafe_condition]
